  ...
  static Future<Map<String, dynamic>> getRecommendations(String username) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Intentar decodificar el error del cuerpo si existe
        try {
          ...
          // Si no se puede decodificar, usar un mensaje genérico
          throw Exception('Error de servidor con código: ${response.statusCode}');
        }
      }
